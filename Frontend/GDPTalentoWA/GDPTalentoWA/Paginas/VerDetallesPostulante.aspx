<%@ Page Title="" Language="C#" MasterPageFile="~/GDPTalento.Master" AutoEventWireup="true" CodeBehind="VerDetallesPostulante.aspx.cs" Inherits="GDPTalentoWA.Paginas.VerDetallesPostulante" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_contenido" runat="server">
     ...
     <a href="Postulantes.aspx" class="btn btn-outline-dark btn-sm">
     ...
     <hr style="border: none; margin: 10px 0;">
      ...
      <div class="card shadow-sm">
          <div class="card-body">
              <h4 class="card-title">Información del postulante</h4>
